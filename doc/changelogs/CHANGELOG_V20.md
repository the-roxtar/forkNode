...
## 2023-12-18, Version 20.11.0 'Iron' (LTS), @UlisesGascon

### Notable Changes

* \[[`51ae4f7f54`](https://github.com/nodejs/node/commit/51ae4f7f54)] - **crypto**: update root certificates to NSS 3.95 (Node.js GitHub Bot) [#50805](https://github.com/nodejs/node/pull/50805)
...
* \[[`ed32e2460d`](https://github.com/nodejs/node/commit/ed32e2460d)] - **fs**: add c++ fast path for writeFileSync utf8 (CanadaHonk) [#49884](https://github.com/nodejs/node/pull/49884)
* \[[`5dc9cf401e`](https://github.com/nodejs/node/commit/5dc9cf401e)] - **(SEMVER-MINOR)** **module**: remove useCustomLoadersIfPresent flag (Chengzhong Wu) [#48655](https://github.com/nodejs/node/pull/48655)
* \[[`01e82e64d4`](https://github.com/nodejs/node/commit/01e82e64d4)] - **(SEMVER-MINOR)** **module**: bootstrap module loaders in shadow realm (Chengzhong Wu) [#48655](https://github.com/nodejs/node/pull/48655)
* \[[`988542cd72`](https://github.com/nodejs/node/commit/988542cd72)] - **(SEMVER-MINOR)** **src**: add `--disable-warning` option (Ethan Arrowood) [#50661](https://github.com/nodejs/node/pull/50661)
* \[[`c78e8090cf`](https://github.com/nodejs/node/commit/c78e8090cf)] - **(SEMVER-MINOR)** **src**: create per isolate proxy env template (Chengzhong Wu) [#48655](https://github.com/nodejs/node/pull/48655)
* \[[`e22a87aabe`](https://github.com/nodejs/node/commit/e22a87aabe)] - **(SEMVER-MINOR)** **src**: make process binding data weak (Chengzhong Wu) [#48655](https://github.com/nodejs/node/pull/48655)
...
* \[[`73b188bf6e`](https://github.com/nodejs/node/commit/73b188bf6e)] - **benchmark**: update iterations in benchmark/util/splice-one.js (Liu Jia) [#50698](https://github.com/nodejs/node/pull/50698)
* \[[`cd1703e36d`](https://github.com/nodejs/node/commit/cd1703e36d)] - **benchmark**: increase the iteration number to an appropriate value (Lei Shi) [#50766](https://github.com/nodejs/node/pull/50766)
* \[[`c5d388f21e`](https://github.com/nodejs/node/commit/c5d388f21e)] - **benchmark**: rewrite import.meta benchmark (Joyee Cheung) [#50683](https://github.com/nodejs/node/pull/50683)
* \[[`9adc8ae7be`](https://github.com/nodejs/node/commit/9adc8ae7be)] - **benchmark**: add misc/startup-cli-version benchmark (Joyee Cheung) [#50684](https://github.com/nodejs/node/pull/50684)
* \[[`1d2c1a0398`](https://github.com/nodejs/node/commit/1d2c1a0398)] - **benchmark**: remove punycode from require-builtins fixture (Joyee Cheung) [#50689](https://github.com/nodejs/node/pull/50689)
...
* \[[`f916774dfe`](https://github.com/nodejs/node/commit/f916774dfe)] - **build**: add GN configurations for simdjson (Cheng Zhao) [#50831](https://github.com/nodejs/node/pull/50831)
* \[[`c10f4346df`](https://github.com/nodejs/node/commit/c10f4346df)] - **build**: add configuration flag to enable Maglev (Keyhan Vakil) [#50692](https://github.com/nodejs/node/pull/50692)
* \[[`590017bf5a`](https://github.com/nodejs/node/commit/590017bf5a)] - **build**: fix GN configuration for deps/base64 (Cheng Zhao) [#50696](https://github.com/nodejs/node/pull/50696)
* \[[`b1d7996938`](https://github.com/nodejs/node/commit/b1d7996938)] - **build**: disable flag v8\_scriptormodule\_legacy\_lifetime (Chengzhong Wu) [#50616](https://github.com/nodejs/node/pull/50616)
...
* \[[`51ae4f7f54`](https://github.com/nodejs/node/commit/51ae4f7f54)] - **crypto**: update root certificates to NSS 3.95 (Node.js GitHub Bot) [#50805](https://github.com/nodejs/node/pull/50805)
* \[[`2d9f5bc0d3`](https://github.com/nodejs/node/commit/2d9f5bc0d3)] - **deps**: update zlib to 1.2.13.1-motley-5daffc7 (Node.js GitHub Bot) [#50803](https://github.com/nodejs/node/pull/50803)
* \[[`f74a6eaef2`](https://github.com/nodejs/node/commit/f74a6eaef2)] - **deps**: update undici to 5.27.2 (Node.js GitHub Bot) [#50813](https://github.com/nodejs/node/pull/50813)
* \[[`db663b75cc`](https://github.com/nodejs/node/commit/db663b75cc)] - **deps**: V8: cherry-pick 0f9ebbc672c7 (Chengzhong Wu) [#50867](https://github.com/nodejs/node/pull/50867)
* \[[`d9fa44cbb0`](https://github.com/nodejs/node/commit/d9fa44cbb0)] - **deps**: V8: cherry-pick 13192d6e10fa (Levi Zim) [#50552](https://github.com/nodejs/node/pull/50552)
* \[[`256b57c55c`](https://github.com/nodejs/node/commit/256b57c55c)] - **deps**: update zlib to 1.2.13.1-motley-dfc48fc (Node.js GitHub Bot) [#50456](https://github.com/nodejs/node/pull/50456)
* \[[`9fb34c0e47`](https://github.com/nodejs/node/commit/9fb34c0e47)] - **deps**: update llhttp to 9.1.3 (Node.js GitHub Bot) [#50080](https://github.com/nodejs/node/pull/50080)
* \[[`2e0c11bed9`](https://github.com/nodejs/node/commit/2e0c11bed9)] - **deps**: update ada to 2.7.4 (Node.js GitHub Bot) [#50815](https://github.com/nodejs/node/pull/50815)
* \[[`abd4c1e8e5`](https://github.com/nodejs/node/commit/abd4c1e8e5)] - **deps**: update minimatch to 9.0.3 (Node.js GitHub Bot) [#50806](https://github.com/nodejs/node/pull/50806)
* \[[`598c2052dc`](https://github.com/nodejs/node/commit/598c2052dc)] - **deps**: update simdutf to 4.0.4 (Node.js GitHub Bot) [#50772](https://github.com/nodejs/node/pull/50772)
* \[[`a5bfe95422`](https://github.com/nodejs/node/commit/a5bfe95422)] - **deps**: upgrade npm to 10.2.4 (npm team) [#50751](https://github.com/nodejs/node/pull/50751)
* \[[`b7218b4281`](https://github.com/nodejs/node/commit/b7218b4281)] - **deps**: escape Python strings correctly (Michaël Zasso) [#50695](https://github.com/nodejs/node/pull/50695)
...
* \[[`ce725bcc62`](https://github.com/nodejs/node/commit/ce725bcc62)] - **dns**: call handle.setServers() with a valid array (Luigi Pinca) [#50811](https://github.com/nodejs/node/pull/50811)
* \[[`3d97e77b47`](https://github.com/nodejs/node/commit/3d97e77b47)] - **doc**: recommend supported Python versions (Luigi Pinca) [#50407](https://github.com/nodejs/node/pull/50407)
* \[[`7f1107a740`](https://github.com/nodejs/node/commit/7f1107a740)] - **doc**: update notable changes in v21.1.0 (Joyee Cheung) [#50388](https://github.com/nodejs/node/pull/50388)
* \[[`d57b998aaa`](https://github.com/nodejs/node/commit/d57b998aaa)] - **doc**: make theme consistent across api and other docs (Dima Demakov) [#50877](https://github.com/nodejs/node/pull/50877)
* \[[`a16b753789`](https://github.com/nodejs/node/commit/a16b753789)] - **doc**: add a section regarding `instanceof` in `primordials.md` (Antoine du Hamel) [#50874](https://github.com/nodejs/node/pull/50874)
* \[[`45ff564d99`](https://github.com/nodejs/node/commit/45ff564d99)] - **doc**: update email to reflect affiliation (Yagiz Nizipli) [#50856](https://github.com/nodejs/node/pull/50856)
* \[[`b2231a4416`](https://github.com/nodejs/node/commit/b2231a4416)] - **doc**: shard not supported with watch mode (Pulkit Gupta) [#50640](https://github.com/nodejs/node/pull/50640)
* \[[`8070f6f807`](https://github.com/nodejs/node/commit/8070f6f807)] - **doc**: get rid of unnecessary `eslint-skip` comments (Antoine du Hamel) [#50829](https://github.com/nodejs/node/pull/50829)
* \[[`4d85763650`](https://github.com/nodejs/node/commit/4d85763650)] - **doc**: create deprecation code for isWebAssemblyCompiledModule (Marco Ippolito) [#50486](https://github.com/nodejs/node/pull/50486)
* \[[`135ec0ab7c`](https://github.com/nodejs/node/commit/135ec0ab7c)] - **doc**: add CanadaHonk to triagers (CanadaHonk) [#50848](https://github.com/nodejs/node/pull/50848)
* \[[`d66cf00dcc`](https://github.com/nodejs/node/commit/d66cf00dcc)] - **doc**: fix typos in --allow-fs-\* (Tobias Nießen) [#50845](https://github.com/nodejs/node/pull/50845)
* \[[`3eb9e4e2a7`](https://github.com/nodejs/node/commit/3eb9e4e2a7)] - **doc**: update Crypto API doc for x509.keyUsage (Daniel Meechan) [#50603](https://github.com/nodejs/node/pull/50603)
* \[[`f89a5ebb25`](https://github.com/nodejs/node/commit/f89a5ebb25)] - **doc**: fix fs.writeFileSync return value documentation (Ryan Zimmerman) [#50760](https://github.com/nodejs/node/pull/50760)
* \[[`0e1b61ab5a`](https://github.com/nodejs/node/commit/0e1b61ab5a)] - **doc**: update print results(detail) in `PerformanceEntry` (Jungku Lee) [#50723](https://github.com/nodejs/node/pull/50723)
* \[[`4648aa40cd`](https://github.com/nodejs/node/commit/4648aa40cd)] - **doc**: fix `Buffer.allocUnsafe` documentation (Mert Can Altın) [#50686](https://github.com/nodejs/node/pull/50686)
* \[[`1fee34f642`](https://github.com/nodejs/node/commit/1fee34f642)] - **doc**: run license-builder (github-actions\[bot]) [#50691](https://github.com/nodejs/node/pull/50691)
* \[[`a541b78bdb`](https://github.com/nodejs/node/commit/a541b78bdb)] - **doc**: add MrJithil to collaborators (Jithil P Ponnan) [#50666](https://github.com/nodejs/node/pull/50666)
...
* \[[`06cee79aee`](https://github.com/nodejs/node/commit/06cee79aee)] - **esm**: fallback to `getSource` when `load` returns nullish `source` (Antoine du Hamel) [#50825](https://github.com/nodejs/node/pull/50825)
* \[[`2239d66786`](https://github.com/nodejs/node/commit/2239d66786)] - **esm**: do not call `getSource` when format is `commonjs` (Francesco Trotta) [#50465](https://github.com/nodejs/node/pull/50465)
...
* \[[`c1a196c897`](https://github.com/nodejs/node/commit/c1a196c897)] - **(SEMVER-MINOR)** **esm**: add import.meta.dirname and import.meta.filename (James Sumners) [#48740](https://github.com/nodejs/node/pull/48740)
* \[[`ed32e2460d`](https://github.com/nodejs/node/commit/ed32e2460d)] - **fs**: add c++ fast path for writeFileSync utf8 (CanadaHonk) [#49884](https://github.com/nodejs/node/pull/49884)
* \[[`831eff401b`](https://github.com/nodejs/node/commit/831eff401b)] - **fs**: improve error perf of sync `lstat`+`fstat` (CanadaHonk) [#49868](https://github.com/nodejs/node/pull/49868)
* \[[`0d59dda780`](https://github.com/nodejs/node/commit/0d59dda780)] - **fs**: improve error performance for `rmdirSync` (CanadaHonk) [#49846](https://github.com/nodejs/node/pull/49846)
* \[[`55b8e48148`](https://github.com/nodejs/node/commit/55b8e48148)] - **fs**: fix to not return for void function (Jungku Lee) [#50769](https://github.com/nodejs/node/pull/50769)
* \[[`9a1b553adb`](https://github.com/nodejs/node/commit/9a1b553adb)] - **fs**: replace deprecated `path._makeLong` in copyFile (CanadaHonk) [#50844](https://github.com/nodejs/node/pull/50844)
...
* \[[`682491864e`](https://github.com/nodejs/node/commit/682491864e)] - **inspector**: use private fields instead of symbols (Yagiz Nizipli) [#50776](https://github.com/nodejs/node/pull/50776)
* \[[`057e37ce86`](https://github.com/nodejs/node/commit/057e37ce86)] - **lib**: use primordials for navigator.userAgent (Aras Abbasi) [#50467](https://github.com/nodejs/node/pull/50467)
...
* \[[`0d04c8a496`](https://github.com/nodejs/node/commit/0d04c8a496)] - **meta**: clarify nomination process according to Node.js charter (Matteo Collina) [#50834](https://github.com/nodejs/node/pull/50834)
* \[[`c0c887593f`](https://github.com/nodejs/node/commit/c0c887593f)] - **meta**: clarify recommendation for bug reproductions (Antoine du Hamel) [#50882](https://github.com/nodejs/node/pull/50882)
* \[[`e91615b487`](https://github.com/nodejs/node/commit/e91615b487)] - **meta**: move cjihrig to TSC regular member (Colin Ihrig) [#50816](https://github.com/nodejs/node/pull/50816)
...
* \[[`53334cdf93`](https://github.com/nodejs/node/commit/53334cdf93)] - **net**: check pipe mode and path (theanarkh) [#50770](https://github.com/nodejs/node/pull/50770)
...
* \[[`2cf5bda891`](https://github.com/nodejs/node/commit/2cf5bda891)] - **perf\_hooks**: implement performance.now() with fast API calls (Joyee Cheung) [#50492](https://github.com/nodejs/node/pull/50492)
* \[[`ed9ab90e79`](https://github.com/nodejs/node/commit/ed9ab90e79)] - **permission**: do not create symlinks if target is relative (Tobias Nießen) [#49156](https://github.com/nodejs/node/pull/49156)
* \[[`70559bef86`](https://github.com/nodejs/node/commit/70559bef86)] - **permission**: mark const functions as such (Tobias Nießen) [#50705](https://github.com/nodejs/node/pull/50705)
...
* \[[`72f1605da3`](https://github.com/nodejs/node/commit/72f1605da3)] - **src**: iterate on import attributes array correctly (Michaël Zasso) [#50703](https://github.com/nodejs/node/pull/50703)
* \[[`8109ff589e`](https://github.com/nodejs/node/commit/8109ff589e)] - **src**: assert return value of BN\_bn2binpad (Tobias Nießen) [#50860](https://github.com/nodejs/node/pull/50860)
* \[[`ba56d6f041`](https://github.com/nodejs/node/commit/ba56d6f041)] - **src**: fix coverity warning (Michael Dawson) [#50846](https://github.com/nodejs/node/pull/50846)
* \[[`994b38d431`](https://github.com/nodejs/node/commit/994b38d431)] - **src**: fix compatility with upcoming V8 12.1 APIs (Cheng Zhao) [#50709](https://github.com/nodejs/node/pull/50709)
* \[[`988542cd72`](https://github.com/nodejs/node/commit/988542cd72)] - **(SEMVER-MINOR)** **src**: add `--disable-warning` option (Ethan Arrowood) [#50661](https://github.com/nodejs/node/pull/50661)
* \[[`f804b3a8f8`](https://github.com/nodejs/node/commit/f804b3a8f8)] - **src**: add IsolateScopes before using isolates (Keyhan Vakil) [#50680](https://github.com/nodejs/node/pull/50680)
* \[[`0e7acf91fe`](https://github.com/nodejs/node/commit/0e7acf91fe)] - **src**: avoid copying strings in FSPermission::Apply (Tobias Nießen) [#50662](https://github.com/nodejs/node/pull/50662)
* \[[`dc1bd410cb`](https://github.com/nodejs/node/commit/dc1bd410cb)] - **src**: remove erroneous default argument in RadixTree (Tobias Nießen) [#50736](https://github.com/nodejs/node/pull/50736)
* \[[`19c8da595f`](https://github.com/nodejs/node/commit/19c8da595f)] - **src**: fix JSONParser leaking internal V8 scopes (Keyhan Vakil) [#50688](https://github.com/nodejs/node/pull/50688)
* \[[`a848312b93`](https://github.com/nodejs/node/commit/a848312b93)] - **src**: return error --env-file if file is not found (Ardi Nugraha) [#50588](https://github.com/nodejs/node/pull/50588)
* \[[`c78e8090cf`](https://github.com/nodejs/node/commit/c78e8090cf)] - **(SEMVER-MINOR)** **src**: create per isolate proxy env template (Chengzhong Wu) [#48655](https://github.com/nodejs/node/pull/48655)
* \[[`e22a87aabe`](https://github.com/nodejs/node/commit/e22a87aabe)] - **(SEMVER-MINOR)** **src**: make process binding data weak (Chengzhong Wu) [#48655](https://github.com/nodejs/node/pull/48655)
...
* \[[`6c024f975d`](https://github.com/nodejs/node/commit/6c024f975d)] - **stream**: fix enumerability of ReadableStream.from (Mattias Buelens) [#50779](https://github.com/nodejs/node/pull/50779)
* \[[`df7bffe8d0`](https://github.com/nodejs/node/commit/df7bffe8d0)] - **stream**: fix enumerability of ReadableStream.prototype.values (Mattias Buelens) [#50779](https://github.com/nodejs/node/pull/50779)
* \[[`21c61f51ab`](https://github.com/nodejs/node/commit/21c61f51ab)] - **stream**: add Symbol.toStringTag to Compression Streams (Filip Skokan) [#50712](https://github.com/nodejs/node/pull/50712)
...
* \[[`da0a78af1c`](https://github.com/nodejs/node/commit/da0a78af1c)] - **test**: fix message v8 not normalising alphanumeric paths (Jithil P Ponnan) [#50730](https://github.com/nodejs/node/pull/50730)
* \[[`f493ca8e11`](https://github.com/nodejs/node/commit/f493ca8e11)] - **test**: fix dns test case failures after c-ares update to 1.21.0+ (Brad House) [#50743](https://github.com/nodejs/node/pull/50743)
* \[[`8ba10bb7f0`](https://github.com/nodejs/node/commit/8ba10bb7f0)] - **test**: replace forEach with for of (Conor Watson) [#50594](https://github.com/nodejs/node/pull/50594)
* \[[`0ad36c2230`](https://github.com/nodejs/node/commit/0ad36c2230)] - **test**: replace forEach to for at test-webcrypto-sign-verify-ecdsa.js (Alessandro Di Nisio) [#50795](https://github.com/nodejs/node/pull/50795)
* \[[`347e92aff4`](https://github.com/nodejs/node/commit/347e92aff4)] - **test**: replace foreach with for in test-https-simple.js (Shikha Mehta) [#49793](https://github.com/nodejs/node/pull/49793)
* \[[`5de5914f98`](https://github.com/nodejs/node/commit/5de5914f98)] - **test**: add note about unresolved spec issue (Mattias Buelens) [#50779](https://github.com/nodejs/node/pull/50779)
* \[[`8dfea1077a`](https://github.com/nodejs/node/commit/8dfea1077a)] - **test**: add note about readable streams with type owning (Mattias Buelens) [#50779](https://github.com/nodejs/node/pull/50779)
* \[[`0ed5f2a5a2`](https://github.com/nodejs/node/commit/0ed5f2a5a2)] - **test**: replace forEach with for-of in test-url-relative (vitosorriso) [#50788](https://github.com/nodejs/node/pull/50788)
* \[[`3c7dde37f8`](https://github.com/nodejs/node/commit/3c7dde37f8)] - **test**: replace forEach() with for ... of in test-tls-getprotocol.js (Steve Goode) [#50600](https://github.com/nodejs/node/pull/50600)
* \[[`8c36c3817f`](https://github.com/nodejs/node/commit/8c36c3817f)] - **test**: enable idlharness tests for encoding (Mattias Buelens) [#50778](https://github.com/nodejs/node/pull/50778)
* \[[`5a76924e59`](https://github.com/nodejs/node/commit/5a76924e59)] - **test**: replace forEach in whatwg-encoding-custom-interop (Honza Machala) [#50607](https://github.com/nodejs/node/pull/50607)
* \[[`6b21cca344`](https://github.com/nodejs/node/commit/6b21cca344)] - **test**: replace forEach() with for-loop (Jan) [#50596](https://github.com/nodejs/node/pull/50596)
* \[[`0998f9f4e2`](https://github.com/nodejs/node/commit/0998f9f4e2)] - **test**: improve test-bootstrap-modules.js (Joyee Cheung) [#50708](https://github.com/nodejs/node/pull/50708)
* \[[`560c0f3b50`](https://github.com/nodejs/node/commit/560c0f3b50)] - **test**: skip parallel/test-macos-app-sandbox if disk space < 120MB (Joyee Cheung) [#50764](https://github.com/nodejs/node/pull/50764)
* \[[`37f3ebc46a`](https://github.com/nodejs/node/commit/37f3ebc46a)] - **test**: replace foreach with for (Markus Muschol) [#50599](https://github.com/nodejs/node/pull/50599)
* \[[`b67665ff97`](https://github.com/nodejs/node/commit/b67665ff97)] - **test**: test streambase has already has a consumer (Jithil P Ponnan) [#48059](https://github.com/nodejs/node/pull/48059)
...
* \[[`4a830c2d9d`](https://github.com/nodejs/node/commit/4a830c2d9d)] - **(SEMVER-MINOR)** **test\_runner**: add Date to the supported mock APIs (Lucas Santos) [#48638](https://github.com/nodejs/node/pull/48638)
* \[[`842dc01def`](https://github.com/nodejs/node/commit/842dc01def)] - **(SEMVER-MINOR)** **test\_runner, cli**: add --test-timeout flag (Shubham Pandey) [#50443](https://github.com/nodejs/node/pull/50443)
* \[[`37e22e35c3`](https://github.com/nodejs/node/commit/37e22e35c3)] - **tls**: fix order of setting cipher before setting cert and key (Kumar Rishav) [#50186](https://github.com/nodejs/node/pull/50186)
...
* \[[`b3836e4c8a`](https://github.com/nodejs/node/commit/b3836e4c8a)] - **tools**: add macOS notarization verification step (Ulises Gascón) [#50833](https://github.com/nodejs/node/pull/50833)
* \[[`eec1fd93b7`](https://github.com/nodejs/node/commit/eec1fd93b7)] - **tools**: use macOS keychain to notarize the releases (Ulises Gascón) [#50715](https://github.com/nodejs/node/pull/50715)
* \[[`f0ac988cec`](https://github.com/nodejs/node/commit/f0ac988cec)] - **tools**: update eslint to 8.54.0 (Node.js GitHub Bot) [#50809](https://github.com/nodejs/node/pull/50809)
* \[[`5b6c21f927`](https://github.com/nodejs/node/commit/5b6c21f927)] - **tools**: update lint-md-dependencies to rollup\@4.5.0 (Node.js GitHub Bot) [#50807](https://github.com/nodejs/node/pull/50807)
* \[[`6beb18b07a`](https://github.com/nodejs/node/commit/6beb18b07a)] - **tools**: add workflow to update release links (Michaël Zasso) [#50710](https://github.com/nodejs/node/pull/50710)
* \[[`5e6f9edf53`](https://github.com/nodejs/node/commit/5e6f9edf53)] - **tools**: recognize GN files in dep\_updaters (Cheng Zhao) [#50693](https://github.com/nodejs/node/pull/50693)
* \[[`144431bb8e`](https://github.com/nodejs/node/commit/144431bb8e)] - **tools**: remove unused file (Ulises Gascon) [#50622](https://github.com/nodejs/node/pull/50622)
...
* \[[`a772b82e9d`](https://github.com/nodejs/node/commit/a772b82e9d)] - **util**: improve performance of normalizeEncoding (kylo5aby) [#50721](https://github.com/nodejs/node/pull/50721)
* \[[`47700281c9`](https://github.com/nodejs/node/commit/47700281c9)] - **v8,tools**: expose necessary V8 defines (Cheng Zhao) [#50820](https://github.com/nodejs/node/pull/50820)
...
* \[[`4c9099f762`](https://github.com/nodejs/node/commit/4c9099f762)] - **win,tools**: upgrade Windows signing to smctl (Stefan Stojanovic) [#50956](https://github.com/nodejs/node/pull/50956)
